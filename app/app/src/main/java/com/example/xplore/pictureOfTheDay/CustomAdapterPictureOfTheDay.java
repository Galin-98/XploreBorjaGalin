...
public class CustomAdapterPictureOfTheDay extends BaseAdapter {
    ...
    @Override
    public int getCount() {
       return PictureOfTheDay7List.names.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       name.setText(PictureOfTheDay7List.names.get(position));
       date.setText(PictureOfTheDay7List.dates.get(position));
        ...
        Picasso.get().load(PictureOfTheDay7List.photosLink.get(position)).transform(trans).into(img);
